...
- [x] Hook: `beforeCreate` → `checkNameLength` (name > 2 characters)
...
- [x] Fields:
    ...
    - [x] title (VARCHAR)
    - [x] content (TEXT)
    - [x] userId (FK → Users) => auto generated by `sequelize Associations` 
    - [x] createdAt => auto generated by `timestamps: true`
...
- [x] Fields:
    - [x] id (PK, Auto Increment) => auto generated by `sequelize`
    - [x] content (TEXT)
    - [x] postId (FK → Posts) => auto generated by `sequelize Associations`
    - [x] userId (FK → Users) => auto generated by `sequelize Associations`
    - [x] createdAt => auto generated by `timestamps: true`
    - [x] updatedAt => auto generated by `timestamps: true`
...
- [ ] **POST /posts**
    - [ ] Create post using new instance + save
